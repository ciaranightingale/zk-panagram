...
contract PanagramTest is Test {
    ...
    function _getProof(bytes32 guess, bytes32 correctAnswer, address _user) internal returns (bytes memory _proof) {
        ...
        (_proof, ) = abi.decode(result, (bytes, bytes32[]));
    }
    ...
    function testIncorrectGuessFails() public {
        ...
        // create the INCORRECT_ANSWER using INCORRECT_GUESS
        bytes32 INCORRECT_ANSWER = bytes32(uint256(keccak256(abi.encodePacked(INCORRECT_GUESS))) % FIELD_MODULUS);
